            ...
            <form method="POST">
                ...
                <div class="row p-3 d-flex align-items-center">
                    <div class="col-9 h-50 input-group d-flex align-items-center">
                        ...
                        <input type="url" class="form-control" id="image-url" name="pictureUrl" required placeholder="Link to picture..." value="${(post.pictureUrl)!}">
                    </div>
                ...
                <div class="form-row text-center">
                    <button type="submit" id="btn-submit" class="btn btn-success m-3 p-2 w-50 center-block">Update</button>
                </div>
            </form>
        </div>
    </div>
